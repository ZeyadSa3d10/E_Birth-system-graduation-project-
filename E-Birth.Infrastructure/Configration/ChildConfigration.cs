...
{
    public class ChildConfigration : IEntityTypeConfiguration<Child>
    {
        public void Configure(EntityTypeBuilder<Child> builder)
        {
            ...
            builder.Property(p => p.NationalId).IsRequired().HasMaxLength(250);
            builder.HasIndex(p => p.NationalId).IsUnique();
            builder.Property(p => p.FullName).IsRequired().HasMaxLength(14);
